...
function genCaptcha(){
  ...
  if (ran3==4) {
    if(randomNum1%randomNum2 != 0){
      randomNum1 = randomNum2*Math.ceil(Math.random()* 4);
    }
    document.getElementById("captchha").innerHTML =
    randomNum1+"&nbsp;/&nbsp;"+randomNum2+"&nbsp;=";
...
function captchaSubmit(){
  if(total != document.getElementById("soln").value){
    document.getElementById("suptext").innerHTML = "<b>Refresh to retry!!</b>";
    ...
    "<b><i>Captcha submitted successfully!!</b></i>";
...
function validateForm() {
  ...
  var cty1 = document.myForm.city1.value;
  var stt1 = document.myForm.state1.value;
  var cntry1 = document.myForm.country1.value;
  var pswrd = document.myForm.pwd.value;
  var pswrd1 = document.myForm.pwd1.value; 
  ...
  if(document.myForm.dob.value >= today ){
    alert("Date can not be from future!!");
